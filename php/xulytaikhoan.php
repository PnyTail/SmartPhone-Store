<?php
	...
	function dangNhap() {
		...
		$sql = "SELECT * FROM nguoidung WHERE TaiKhoan='$taikhoan' AND MatKhau='$matkhau' AND MaQuyen IN (1, 2) AND TrangThai=1";
	...
	function dangKy() {
		...
		// đăng nhập vào ngay
		$sql = "SELECT * FROM nguoidung WHERE TaiKhoan='$xuli_newUser' AND MatKhau='$xuli_newPass' AND MaQuyen IN (1, 2) AND TrangThai=1";
		$result = (new DB_driver())->get_row($sql);
